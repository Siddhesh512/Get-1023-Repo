...
public class Main {
	...
	public static void main(String[]args) {
		...
		Student student2=new Student("Mike", LocalDate.of(2001, 9, 15),Qualification.Master,"6858585843","mike@lti.com","Chennai");
		Student student3=new Student("Kevin", LocalDate.of(2000, 1, 22),Qualification.Graduate,"7858585843","kevin@lti.com","Pune");
		Student student4=new Student("Brett", LocalDate.of(2001, 11, 12),Qualification.Intermediate,"8858585843","brett@lti.com","Bengaluru");
